...
wget https://raw.githubusercontent.com/0chain/asdeploy/update-blobber-deploy/blob_nginx.sh -O nginx.sh
wget https://raw.githubusercontent.com/0chain/asdeploy/update-blobber-deploy/blob_config.sh -O blob_config.sh
wget https://raw.githubusercontent.com/0chain/asdeploy/update-blobber-deploy/blob_gen.sh -O blob_gen.sh
wget https://raw.githubusercontent.com/0chain/asdeploy/update-blobber-deploy/blob_files.sh -O blob_files.sh
wget https://raw.githubusercontent.com/0chain/asdeploy/update-blobber-deploy/blob_run.sh -O blob_run.sh
wget https://raw.githubusercontent.com/0chain/asdeploy/update-blobber-deploy/blob_del.sh -O blob_del.sh
